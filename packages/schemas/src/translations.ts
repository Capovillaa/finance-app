...
export const VALIDATION_MESSAGES: Record<ValidationLocale, Record<ValidationMessageName, string>> = {
  en: {
    ...
    passwordBreached: 'This password has appeared in a data breach. Choose a different one.',
  ...
  'pt-BR': {
    ...
    passwordBreached: 'Esta senha já apareceu em um vazamento de dados. Escolha outra.',
  ...
  es: {
    ...
    passwordBreached: 'Esta contraseña ya apareció en una filtración de datos. Elige otra.',
